...
HD_PWD='/home/fedora/Dokumente/Schule/Fachhochschule/Semester_4/Chip_Design/Project_VGA_Controller/code/generate/rom_mem2/managed_ip_project/managed_ip_project.runs/rom_mem2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_mem2.vds -m64 -mode batch -messageDb vivado.pb -notrace -source rom_mem2.tcl
