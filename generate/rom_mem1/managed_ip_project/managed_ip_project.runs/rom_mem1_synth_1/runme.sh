...
HD_PWD='/home/fedora/Dokumente/Schule/Fachhochschule/Semester_4/Chip_Design/Project_VGA_Controller/code/generate/rom_mem1/managed_ip_project/managed_ip_project.runs/rom_mem1_synth_1'
cd "$HD_PWD"
